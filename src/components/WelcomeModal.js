    ...
    return (
        <div className="welcome-cont">
            <div className="welcome-message">
                <h1>
                    Hello, Which parts of speech would you like to learn today?
                </h1>
            </div>
                ...
                >
                    <div
                        style={{
                            transition: ".2s",
                            opacity:
                                wordTypes.indexOf("adverbs") === -1 ? 0 : 1,
                        }}
                        className="pos-card-selected"
                    ></div>
                ...
                >
                    <div
                        style={{
                            transition: ".2s",
                            opacity:
                                wordTypes.indexOf("adjectives") === -1 ? 0 : 1,
                        }}
                        className="pos-card-selected"
                    ></div>
        ...
        <Backdrop onClick={() => setWelcomeModalOpen(false)} user="welcome">
            ...
            >
                ...
                <div className="challenge-toggle-opt-cont">
                    <label style={{ scale: "0.8" }} className="switch">
                        <input
                            checked={difficulty}
                            type="checkbox"
                            onChange={(e) => {
